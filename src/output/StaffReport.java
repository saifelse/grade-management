...
public class StaffReport {
    ...
    private static String writeStudentGrades(Student[] students) throws IOException {
        ...
        for (Student s : students) {
            ...
            String report_link = "<a id=\"" + s.email + "\" href=\"./staff/grades/" + s.fullEmail + ".shtml\" target=\"_blank\">" + s.email  + "</a>";
            ...
            rowCols.add(Helpers.writeJSMap(Helpers.vfp(
                    ...
                    "{style: 'width: 100px'}")));
            rowCols.add(Helpers.writeJSMap(Helpers.vfp(
                    Helpers.gradeDecimalformat.format(s.aux.typeTotals.get(GradeType.M)), 
