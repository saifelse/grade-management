...
public class GradesheetReader extends KeyDataReader {
    ...
    public GradesheetReader(String f, Reader r) throws ReaderException {
        ...
        try {
            ...
            if (!(keys.contains(EMAIL))) {
        	 ...
        	 throw new ReaderException(f+": "+e.getMessage(), true);
        } catch(IOException e) {
            throw new ReaderException(f+": "+e.getMessage(), true);
        }
    }
    ...
    public GradesheetRow getNextRow() throws ReaderException {
        try {
           ...
           // System.out.println("Keys in this row: "+row.keySet().toString());
            ...
            throw new ReaderException("Gradesheet has row with missing columns: "+row.toString(), false);
        } catch(IOException e) {
